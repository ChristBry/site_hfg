    ...
    return (
        <div className="header fixed z-20">
            <div className='infos-header-container flex justify-between items-center p-4'>
                <div className="infos-header-title w-[100%] sm:flex sm:gap-10">
            ...
            <div className="nav bg-primary shadow-lg">
                <div className="flex items-center justify-between">
                    ...
                    <ul className="nav-list hidden lg:flex sm:w-[100%] flex justify-center sm:gap-3 xl:gap-8">
                        <li className="text-xl"><Link to='/'>Accueil</Link></li>
                        <li className="text-xl"><Link to='/about'>Qui Sommes-Nous</Link></li>
                        <li className="text-xl"><Link to='/services'>Nos Services</Link></li>
                        <li className="text-xl"><Link to='/about'>Actualités</Link></li>
                    ...
                    <div className='header-action hidden w-[70%] sm:w-[35%] xl:w-[20%] lg:flex items-center justify-center rounded-full'>
                        <a href='https://wa.me/237670897408?text=Bonjour%20je%20souhaite%20prendre%20un%20rendez%20vous' target='_blank' className='flex items-center'>Contactez-Nous<i className="fa-solid fa-arrow-up-right-from-square text-lg"></i></a>
                    </div>
                </div>
                {open && 
